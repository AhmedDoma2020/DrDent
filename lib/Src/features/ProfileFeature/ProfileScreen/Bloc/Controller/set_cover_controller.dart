...
import 'package:dr_dent/Src/features/ProfileFeature/ProfileScreen/Bloc/Repo/set_cover_repo.dart';
...
class SetCoverController extends GetxController {

  RequestStatus status = RequestStatus.initial;
  final FetchProfileController _fetchProfileController = Get.put(FetchProfileController());
  final  SetCoverRepository _setCoverRepository =SetCoverRepository();
  Future<void> setCover({required String image}) async {
    setLoading();
    var response = await _setCoverRepository.setCover(image: image);
    Get.back();
