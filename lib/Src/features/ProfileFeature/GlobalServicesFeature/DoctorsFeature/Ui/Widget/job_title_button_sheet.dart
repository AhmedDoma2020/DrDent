...
class JobTitleButtonSheet extends StatelessWidget {
  final Function(int,String) onTap;
  const JobTitleButtonSheet({
    Key? key,
    required this.onTap,
  }) : super(key: key);
  @override
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              24.0.ESH(),
              GetBuilder<FetchJobTitleController>(
                builder:(_) =>  SizedBox(
                  height: 400.h,
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) => InkWell(
                      onTap: () {
                        ...
                        onTap(_.jobTitleList[index].id, _.jobTitleList[index].title);
                        Get.back();
                      },
                      child: SingleChoseRowForm(
                        title: _.jobTitleList[index].title,
                    ...
                    itemCount: _.jobTitleList.length,
                  ),
                ),
              ),
            ],
