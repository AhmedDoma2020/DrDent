...
class UniversityDegreeButtonSheet extends StatelessWidget {
  final Function(int,String) onTap;
  const UniversityDegreeButtonSheet({
    Key? key,
    required this.onTap,
  }) : super(key: key);
  @override
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              24.0.ESH(),
              GetBuilder<FetchUniversityDegreeController>(
                builder:(_) =>  SizedBox(
                  height: 400.h,
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) => InkWell(
                      onTap: () {
                        ...
                        onTap(_.universityDegreeList[index].id, _.universityDegreeList[index].title);
                        Get.back();
                      },
                      child: SingleChoseRowForm(
                        title: _.universityDegreeList[index].title,
                        isSelected: _.universityDegreeSIndex == index,
                      ),
                    ),
                    ...
                    itemCount: _.universityDegreeList.length,
                  ),
                ),
              ),
            ],
